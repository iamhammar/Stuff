...
import maniac.ManiacMethods;
import maniac.ManiacGui;
import maniac.ManiacVars;
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            this.mc.mcProfiler.endSection();
									...
									/** ~~~~~~~~~~~~FullBright~~~~~~~~~~~~ **/
        	if(ManiacVars.fullbright || ManiacVars.wallhack){mc.gameSettings.gammaSetting++;
        	}else{mc.gameSettings.gammaSetting = 0.5F;}
        
        
        							/** ~~~~~~~~~~~~CheckKeys~~~~~~~~~~~~ **/
        	if(Keyboard.isKeyDown(Keyboard.KEY_B)){ManiacVars.fullbright = !ManiacVars.fullbright;}
        	if(Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)){mc.displayGuiScreen(new ManiacGui(mc));}
        	if(Keyboard.isKeyDown(Keyboard.KEY_X)){mc.renderGlobal.loadRenderers();ManiacVars.wallhack = !ManiacVars.wallhack;}
